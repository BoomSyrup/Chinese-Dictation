    ...
    render() {
        return (
            ...
            <div class="group_menu">
                ...
                <button class="pushy__btn pushy__btn--sm pushy__btn--red" onClick={() => this.clickTable(11)}>zh ch sh - Basic Endings</button>
                <div class="blank_button"> <button class="pushy__btn pushy__btn--sm pushy__btn--red"> blank </button> </div>
                <button class="pushy__btn pushy__btn--sm pushy__btn--red" onClick={() => this.clickTable(12)}>zh ch sh - u Endings</button>
                <div class="blank_button"> <button class="pushy__btn pushy__btn--sm pushy__btn--red"> blank </button> </div>
